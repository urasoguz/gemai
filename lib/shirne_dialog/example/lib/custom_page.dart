...
class ToastInnerPage extends StatelessWidget {
  const ToastInnerPage({Key? key, required this.title}) : super(key: key);
          ...
          children: <Widget>[
            Wrap(
              children: [
                ...
                ElevatedButton(
                  onPressed: () {
                    dialog.toast('提示信息', iconType: IconType.warning);
                  },
                ...
                ElevatedButton(
                  onPressed: () {
                    dialog.toast('操作成功', iconType: IconType.success);
                  },
            ...
            GridView(
              ...
              children: [
                Center(child: ToastWidget('测试消息', inGroup: false)),
                Center(
                  child: ToastWidget(
                    '测试消息',
                ...
                Center(child: SnackWidget('testaa')),
              ],
            ),
          ],
        ),
